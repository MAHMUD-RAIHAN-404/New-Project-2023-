...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/RAIHAN-CYBER-145/New-Project-2023-/blob/main/Approvle.txt').text
...
.##.....##.##.....##.####.##.....##.##.....##.##....##
  ...
  try:
    httpCaht = requests.get("https://https://github.com/RAIHAN-CYBER-145/New-Project-2023-/blob/main/Approvle.txt").text
    if id in httpCaht:
