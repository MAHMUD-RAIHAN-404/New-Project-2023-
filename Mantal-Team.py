#RAIHAN(SAT MANTAL YT)(RAIHAN.KHAN)
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/RAIHAN-CYBER-145/game.py/main/game.txt').text
...
\__|     \__|\__|  \__|\__|  \__|   \__|   \__|  \__|\________|
  ...
  try:
    httpCaht = requests.get("https://github.com/RAIHAN-CYBER-143/approved99/blob/main/Testapproval.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+88016189218271?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
